...
OUTPUT_DIR=/autodl-fs/data/outputs/saved_model/llamafactory/llamafactory_lora
TRAIN_ARGES=( \
    --task_type generate \
    --train_stage sft \
    --num_train_epochs 3 \
    ...
    --template qwen \
    --llamafactory /autodl-fs/data/LLaMA-Factory/examples/train_lora/llama3_lora_sft.yaml \
)
