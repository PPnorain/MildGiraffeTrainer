...
OUTPUT_DIR=/root/autodl-fs/outputs/saved_model/classify/classify_sentiment
TRAIN_ARGES=( \
    --task_type pooling \
    --train_stage classify \
    --num_train_epochs 3 \
    ...
    --num_labels 9 \
    --bf16 \
    --data_map '{"prompt":"text", "response":"label"}' \
    ...
    --data_path /root/autodl-fs/MGTrainer/test/dataset/tweet_sentiment_extraction/train.jsonl \
